    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card gedf-card rounded overflow-hidden">
                ...
                <!--Comments-->
                <?php $__currentLoopData = $etkinlik->yorumlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card-footer">
                    <div>
                        <form action="<?php echo e(route('postyorum')); ?>" method="POST"  class="row justify-content-between">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" value="<?php echo e($etkinlik->id); ?>" name="post_id">
...
<?php echo $__env->make('katmanlar.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\hayde\resources\views/etkinlik_detay.blade.php ENDPATH**/ ?>