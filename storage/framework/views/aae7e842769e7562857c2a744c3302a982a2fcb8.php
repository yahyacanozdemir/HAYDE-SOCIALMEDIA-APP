...
<?php if($errors->any()): ?>
    ...
    <strong>Uyarı!</strong> <?php echo e($error); ?>
...
<!--<?php if($errors->any()): ?> <?php echo implode('', $errors->all('<div>:message</div>')); ?> <?php endif; ?> -->
                ...
                <div id="flip-box-back" class="flip-box-back">
                    <div class="col-md-12">
                        ...
                        <p class="text mt-0">Hayde ile etkinliklere katıl, yeni bağlantılar kur ve sosyal bir hayat
                            kazan.</p>
                        <form class="mt-0" action="<?php echo e(route('register')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php /**PATH /home/yahya/Desktop/HAYDE-SOCIALMEDIA-APP/resources/views/auth/login.blade.php ENDPATH**/ ?>