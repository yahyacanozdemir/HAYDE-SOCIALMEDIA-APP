...
<div class="center-fixed-profile-content">
    ...
    <div class="container-fluid gedf-wrapper">
        ...
        <div class="row">
                ...
                <div class="card gedf-card rounded overflow-hidden">
                    ...
                    <div class="card-footer row justify-content-center">
                        <form action="<?php echo e(route('etkinlik.katil')); ?>" method="POST">
                            ...
                            <button type="submit" class="card-link btn btn-info"><i class="fa fa-users"></i>
                                Katıl</button>
                        </form>
            ...
            <?php endif; ?> <?php if($entry->paylasim_tipi==3): ?>
            <!--- \\\\\\\Location-->
            <div class="col-md-9 gedf-main">
                <div class="card gedf-card rounded overflow-hidden">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div id="post-uid-owner-username" class="h7 m-0 text-muted">
                                    <?php echo e("@".$entry->kullanici->kullanici_adi); ?></div>
                            </div>
                        </div>
                        <div>
                            <div class="dropdown">
...
<?php echo $__env->make('katmanlar.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yahya/Desktop/hayde/resources/views/anasayfa.blade.php ENDPATH**/ ?>