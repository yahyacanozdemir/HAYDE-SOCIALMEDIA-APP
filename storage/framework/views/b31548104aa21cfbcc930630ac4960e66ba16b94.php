...
<?php $__env->startSection('content'); ?>
    ...
    <div class="center-fixed-profile-card rounded">
        ...
        <div class="cover-container d-flex justify-content-center row" style="background-position: center; background-size: cover; background-repeat:no-repeat; background-image: url(/uploads/image/users/<?php echo e($userglobal->kapak_fotografi); ?>);">
            <div class="cover-edit-image-button">
                <form action="<?php echo e(route('ayarlar.kapakResmKaydet')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('katmanlar.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yahya/Desktop/HAYDE-SOCIALMEDIA-APP/resources/views/profil.blade.php ENDPATH**/ ?>