                        ...
                        <div class="tab-pane fade show active rounded custom-tab-content" id="profilesettings-tab-content" role="tabpanel" aria-labelledby="profilesettings-tab-content">
                            ...
                            <div class="row tab-content-custom-row justify-content-around">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input id="getagenput" class="form-control textinputstyle rounded" type="text"  >
                                </div>
                            </div>
                            ...
                            <div class="row tab-content-custom-row justify-content-around">
                                <div class="col-sm-4 justify-content-between">
                                    ...
                                    <input id="getcountryinput" class="form-control textinputstyle rounded" type="text" >
                                </div>
                                <div class="col-sm-4">
                                    <p class="inputlabel">Şehir</p>
                                    <input id="getcityinput" class="form-control textinputstyle rounded" type="text" name="bulundugu_il" >
                                </div>
                                <div class="col-sm-4">
                                    <p class="inputlabel">İlçe</p>
                                    <input id="getstateinput" class="form-control textinputstyle rounded" type="text" name="bulundugu_ilce" >
                                </div>
                            </div>
                            ...
                            <div class="row tab-content-custom-row justify-content-around">
                                <div class="col-sm-4 justify-content-between">
                                    ...
                                    <input id="getdepartmantinput" class="form-control textinputstyle rounded" type="text" name="bolum_bilgisi" >
                                </div>
                                <div class="col-sm-4">
                                    <p class="inputlabel">Sınıf</p>
                                    <input id="getgradeinput" class="form-control textinputstyle rounded" type="text" name="sinif_bilgisi" >
                                </div>
                                <div class="col-sm-4">
                                    <p class="inputlabel">İlgi Alanı</p>
                                    <input id="getworkspaceinput" class="form-control textinputstyle rounded" type="text" name="ilgi_alani" >
                                </div>
                            </div>
                            ...
                            <div class="row tab-content-custom-row justify-content-around">
                                <div class="col-sm-3 justify-content-between">
                                    ...
                                    <input id="getfacebookadressinput" class="form-control textinputstyle rounded" type="text" name="f" >
                                </div>
                                <div class="col-sm-3">
                                    <p class="inputlabel">Twitter</p>
                                    <input id="gettwitteraddressinput" class="form-control textinputstyle rounded" type="text" name="t" >
                                </div>
                                <div class="col-sm-3">
                                    <p class="inputlabel">Linkedin</p>
                                    <input id="getlinkedinaddressinput" class="form-control textinputstyle rounded" type="text" name="l" >
                                </div>
                                <div class="col-sm-3">
                                    <p class="inputlabel">İnstagram</p>
                                    <input id="getinstagramaddressinput" class="form-control textinputstyle rounded" type="text" name="i" >
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade rounded custom-tab-content" id="accountsettings-tab-content" role="tabpane2" aria-labelledby="accountsettings-tab-content">
                            ...
                            <div class="row tab-content-custom-row justify-content-around">
                                <div class="col-sm-4 justify-content-between">
                                    ...
                                    <input id="getnewusername" class="form-control textinputstyle rounded" type="text" placeholder="yahyacanozdemir">
                                </div>
                                <div class="col-sm-4">
                                    <p class="inputlabel">Birincil E-Posta</p>
                                    <input id="getemail1" class="form-control textinputstyle rounded" type="text" placeholder="18360859048@ogrenci.btu.edu.tr">
                                </div>
                                <div class="col-sm-4">
                                    <p class="inputlabel">İkinci E-Posta</p>
                                    <input id="getemail2" class="form-control textinputstyle rounded" type="text" placeholder="yahyacanozdemir@gmail.com">
                                </div>
                            </div>
                            ...
                            <div class="row tab-content-custom-row justify-content-between">
                                <div class="col-sm-4 justify-content-between">
                                    ...
                                    <input id="getnewphone" class="form-control textinputstyle rounded" type="text" placeholder="+90532532532">
                                </div>
...
<?php echo $__env->make('katmanlar.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yahya/Desktop/hayde/resources/views/ayarlar.blade.php ENDPATH**/ ?>