...
<?php $__env->startSection('css', '/assets/css/profile.css'); ?>

<?php $__env->startSection('content'); ?>

    <!-- Start of User Profile Card -->

    <?php if(Auth::user()->id == $kullanici->id): ?>
    <div class="center-fixed-profile-card rounded">
        ...
        <div class="cover-container d-flex justify-content-center row">
            <div class="cover-edit-image-button">
                <form action="" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                <input type="file" name="pic" class="edit-cover" accept="image/*" onchange="loadcoverphoto(event)" title="Kapak resmini değiştir." />

                </form>
                    <p class="cover-edit-image-icon">&#9998;</p>
            </div>
            <div class="cover-go-settings-button">
                <p title="Ayarlar"><a class="cover-gosettings-icon" href="<?php echo e(route('ayarlar')); ?>">&#9881;</a></p>
        ...
        <div class="profile-card-bottom ">
            <input type="file" name="pic" class="editpp edit-photo" accept="image/*" onchange="loadprofilephoto(event)" title="Profil resmini değiştir." />
            <p class="edit-pp-icon edit-photo-icon">&#9998;</p>
            <a href="/uploads/image/users/<?php echo e($kullanici->profil_fotografi); ?>" class=" fancybox" rel="ligthbox">
                <img src="/uploads/image/users/<?php echo e($kullanici->profil_fotografi); ?>" class="zoom img-fluid rounded-circle" alt="">
            </a>
            <p id="profile-name"><?php echo e($kullanici->ad.' '.$kullanici->soyad); ?></p>
        </div>
        ...
        <div class="col profile-card-left-area">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <p id="postsvalue"><?php echo e(count($kullanici->paylasimlar) + count($kullanici->etkinlikler)); ?></p>
                </div>
                <div class="col-sm-6">
                    <p id="friendsname" class="profile-card-left-texts"><a href="#">Arkadaşlar</a></p>
                    <p id="friendsvalue"><?php echo e(count($kullanici->arkadaslar)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="col profile-card-right-area">
            <div class="row float-right">
                <ul class="social-network social-circle">
                    <li><a href="<?php echo e($kullanici->sosyalmedyahesaplari->facebook); ?>" target="_blank" class="icoFacebook" title="Facebook"><i class="fa fa-facebook"></i></a></li>
                    <li><a href="<?php echo e($kullanici->sosyalmedyahesaplari->twitter); ?>" target="_blank" class="icoTwitter" title="Twitter"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="<?php echo e($kullanici->sosyalmedyahesaplari->linkedin); ?>" target="_blank" class="icoLinkedin" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
                    <li><a href="<?php echo e($kullanici->sosyalmedyahesaplari->instagram); ?>" target="_blank" class="icoGoogle" title="Instagram"><i class="fa fa-instagram"></i></a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="friend-center-fixed-profile-card rounded">
        ...
        <div class="profile-card-bottom col">
            <a href="/uploads/image/users/<?php echo e($kullanici->profil_fotografi); ?>" class=" fancybox" rel="">
                <img src="/uploads/image/users/<?php echo e($kullanici->profil_fotografi); ?>" class="zoom img-fluid rounded-circle" alt="">
            </a>
            <p id="profile-name"><?php echo e($kullanici->ad.' '.$kullanici->soyad); ?></p>
            <div class="row justify-content-center">
                <!-- ARKADAŞ EKLEME BUTONU -->
                <form action="<?php echo e(route('arkadas.ekle')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="kullanici_id" value="<?php echo e($kullanici->id); ?>">
                            <?php if(!$istek_gonderildi->count() && !$istek_kabul_edildi->count() && !$istek_gonderilen->count()): ?>
                            ...
                            <?php elseif($istek_gonderildi->count() && !$istek_kabul_edildi->count() && !$istek_gonderilen->count()): ?>
                            <p class='mt-3' style='color:white'> Arkadaslik Istegi Gonderildi</p>

                            <?php elseif($istek_gonderilen->count()): ?>
        ...
        <div class="col profile-card-left-area">
            <div class="row">
                <div class="col-sm-6">
                    <p id="postsname" class="profile-card-left-texts"><a href="#">Gönderiler</a></p>
                    <p id="postsvalue"><?php echo e(count($kullanici->paylasimlar)); ?></p>
                </div>
                <div class="col-sm-6">
                    <p id="friendsname" class="profile-card-left-texts"><a href="#">Arkadaşlar</a></p>
                    <p id="friendsvalue"><?php echo e(count($kullanici->arkadaslar)); ?></p>
    ...
    <div class="center-fixed-profile-content">
        <div class="container-fluid gedf-wrapper">
                ...
                <div class="col-md-3">
                        ...
                        <div class="card-body">
                            ...
                            <dl class="row justify-content-center align-items-start">
                                ...
                                <dt id="user_aboutcard_departman_info" class="col-sm-9 about-card-text-style">
                                    <?php echo e($kullanici->bolum_bilgisi); ?></dt>

                                <dt class="col-sm-3 about-card-text-style"><i class="far fa-compass"></i></dt>
                                <dt id="user_aboutcard_location_info" class="col-sm-9 about-card-text-style"><?php echo e($kullanici->bulundugu_il); ?></dt>

                                <dt class="col-sm-3 about-card-text-style"><i class="fas fa-briefcase"></i></dt>
                                <dt id="user_aboutcard_workspace_info" class="col-sm-9 about-card-text-style"><?php echo e($kullanici->ilgi_alani); ?></dt>
                            </dl>
                        </div>
                    </div>
                    <!--End of About Card-->
                    ...
                    <div class="card rounded gedf-card overflow-hidden">
                        ...
                        <div class="row" style="padding-left: 10px; padding-right: 10px;">
                            ...
                            <?php $__currentLoopData = $fotograf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 photos-card-photo-div">
                                <a id="user-id-image1-link" href="/uploads/image/paylasimfoto/<?php echo e($entry->fotograf); ?>" class="fancybox" rel="ligthbox">
                                    <img id="user-id-image1" src="/uploads/image/paylasimfoto/<?php echo e($entry->fotograf); ?>" class="zoom img-fluid " alt="">
                    ...
                    <div class=" rounded gedf-card overflow-hidden">
                        ...
                        <div class="row" style="padding-left: 5px; padding-right: 5px;">
                            ...
                            <?php $__currentLoopData = $kullanici->arkadaslar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 friends-card-friend-div ">
                                <a id="user-uid-friend1-link" href="<?php echo e(route('profil', $entry->kullanici_adi)); ?>" class="fancybox" rel="ligthbox">
                                    <img id="user-uid-friend1-img" src="/uploads/image/users/<?php echo e($entry->profil_fotografi); ?>" class="friends-card-img  img-fluid rounded-circle" alt="">
                                    <p id="user-uid-friend1-name_surname" class="friends-card-text-style"><?php echo e($entry->ad); ?></p>
                                </a>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
           ...
           <?php $__currentLoopData = $tumpaylasimlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               ...
               <!--- \\\\\\\YAZI GÖNDERİ-->
                    ...
                    <div class="card gedf-card rounded overflow-hidden">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="ml-2">
                                        <div id="post-uid-owner-name_surname" class="h5" style="color: rgb(169, 183, 247);">
                                            <?php echo e($kullanici->ad.' '.$kullanici->soyad); ?></div>
                                        <div id="post-uid-owner-username" class="h7 m-0 text-muted"><?php echo e("@".$kullanici->kullanici_adi); ?></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="dropdown">
                        ...
                        <div class="card-footer">
                            <a id="post-uid-like" class="card-link"><i class="fa fa-gittip"></i> Beğen</a>
                ...
                <?php if($entry->paylasim_tipi==2): ?>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="ml-2">
                                        <div id="post-uid-owner-name_surname" class="h5" style="color: rgb(169, 183, 247);"><?php echo e($kullanici->ad." ".$kullanici->soyad); ?></div>
                                        <div id="post-uid-owner-username" class="h7 m-0 text-muted"><?php echo e("@".$kullanici->kullanici_adi); ?></div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="post-card-image row justify-content-center">
                                <?php $__currentLoopData = $entry->fotograflar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img id="post-uid-image" src="/uploads/image/paylasimfoto/<?php echo e($list->fotograf); ?>" class="img-fluid" alt="">
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card gedf-card rounded overflow-hidden">
                        ...
                        <div class="card-body">
                            ...
                            <div class=" row justify-content-center" style="margin-top: 50px;">
                                <a id="post-uid-location-link" href="https://maps.google.com/?q=40.935458, 29.139540"> <button type="button" class="btn btn-light">Konumu Gör</button> </a>
                            </div>
                   ...
                   <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     ...
                     <!--- \\\\\\etkinlik-->
                     <?php $__currentLoopData = $tumetkinlikler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card gedf-card rounded overflow-hidden">
                        ...
                        <div class="card-body">
                            ...
                            <div id="event-uid-date" class="alert alert-info event-date-style" role="alert">
                                Tarihler : <br>
                                Başlangıç : <?php echo e($entry->baslangic_tarihi); ?><br> <br>
                                Bitiş : <?php echo e($entry->bitis_tarihi); ?>
...
<?php echo $__env->make('katmanlar.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yahya/Desktop/hayde/resources/views/profil.blade.php ENDPATH**/ ?>