...
<?php $__env->startSection('css', '/assets/css/mainPage.css'); ?>
    ...
    <div class="center-fixed-profile-content">
        ...
        <div class="container-fluid gedf-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-9 gedf-main"><!-- md-12-->
                ...
                <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card gedf-card rounded overflow-hidden">
                            <div class="card-header ">
                                <div class="d-flex justify-content-between align-items-center ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="mr-2">
                                            <a href="<?php echo e(route('profil', $entry->kullanici->kullanici_adi)); ?>"> <img id="post-uid-owner-pp" class="rounded-circle" width="45" src="/uploads/image/users/<?php echo e($entry->kullanici->profil_fotografi); ?>" alt=""></a>
                                        </div>
                                        <div class="ml-2">
                                            <div id="post-uid-owner-name_surname" class="h5" style="color: rgb(169, 183, 247);">
                                                <a href="<?php echo e(route('profil', $entry->kullanici->kullanici_adi)); ?>"><?php echo e($entry->kullanici->ad.' '.$entry->kullanici->soyad); ?></a></div>
                                            <div id="post-uid-owner-username" class="h7 m-0 text-muted"><a href="<?php echo e(route('profil', $entry->kullanici->kullanici_adi)); ?>"><?php echo e("@".$entry->kullanici->kullanici_adi); ?></a></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="dropdown">
            ...
            <?php $__currentLoopData = $yaklasan_etkinlikler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <p><?php echo e($entry->baslik); ?></p>
                <p><?php echo e($entry->created_at->diffInDays()); ?> gün sonra</p>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-md-3">
        ...
        <div class="card rounded gedf-card">
            <div class="card-body">
                ...
                <hr style="background-color: rgb(197, 197, 197);">
                <?php $__currentLoopData = $yaklasan_etkinlikler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <ul class="upcoming-event-list m-0 p-2">
                            <li class="d-flex align-items-center">
                                ...
                                <div class="media-support-info ml-3 ">
                                    <h6 id="upcoming-event-title-1"><a href="../Event-Detail-Page/EventDetail.html" class="upcoming-event-title"><?php echo e($entry->baslik); ?></a></h6>
                                    <p id="upcoming-event-desc-1" class="mb-0 upcoming-event-descr  text-truncate">Oluşturan:
                                        <?php echo e($entry->kullanici->ad); ?></p>
                                </div>
                            </li>
                        </ul>
                        <p1 id="upcoming-event-date-1" class="upcoming-event-date"><?php echo e($entry->baslangic_tarihi); ?></button>
...
<?php $__env->startSection('script'); ?>
                ...
                <script src="<?php echo e(url('mainPage.js')); ?>"></script>
...
<?php echo $__env->make('katmanlar.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\hayde\resources\views/anasayfa.blade.php ENDPATH**/ ?>