                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <img src="/uploads/image/users/{{$userglobal->profil_fotografi}}" class="create-post-profile-pic " /> </div>
                        ...
                        <div class="form">
                            <form action="{{route('post')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3 justify-content-around">
                                    <div class="input-group-prepend">
                                        <img src="/uploads/image/users/{{$userglobal->profil_fotografi}}" class="create-post-profile-pic " />
                                    </div>
